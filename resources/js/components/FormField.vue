<script>
    ...
    export default {
        ...
        mounted() {
            Nova.$on('group-adderol', function(num) {
                console.log("Accesing the argument which is: " + num);
                //console.log(this.$refs.items);
                console.log("Do you see a ref or more complaints?");
            });
        },
        ...
        methods: {
            ...
            populateGroups() {
                ...
                for (var i = 0; i < this.value.length; i++) {
                    console.log("Populating some groups. Hello! And some values for you, starting with this.value[i].layout");
                    console.log(this.value[i].layout);
                    console.log("this.value[i].attributes");
                    this.addGroup(
